import { symEnumName } from './util.js'

/**
 * @see https://bungie-net.github.io/#/components/schemas/Destiny.DestinyComponentType
 */
export const ComponentType = {
  [symEnumName]: 'Destiny.DestinyComponentType',
  None: 0,
  Profiles: 100,
  VendorReceipts: 101,
...
/**
 * @see https://bungie-net.github.io/#/components/schemas/Exceptions.PlatformErrorCodes
 */
export const ErrorCode = {
  [symEnumName]: 'Exceptions.PlatformErrorCodes',
  None: 0,
  Success: 1,
  ...
  /**
   * Note: This is one of those holdovers from Destiny 1.
   * We didn't change the enum because I am lazy, but in Destiny 2 this would read `"DestinyCharacterNotInSocialSpace"`,
   */
...
/**
 * @see https://bungie-net.github.io/#/components/schemas/BungieMembershipType
 */
export const MembershipType = {
  [symEnumName]: 'BungieMembershipType',
  None: 0,
  TigerXbox: 1,
  TigerPsn: 2,
  TigerSteam: 3,
